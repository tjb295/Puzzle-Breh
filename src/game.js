...
var main_menu = PIXI.Sprite.fromImage("./assets/start.png");
...
var glass = new PIXI.Sprite(PIXI.Texture.fromImage("./assets/glass.png"));
glass.position.x = 60;
glass.position.y = 340;
glass.anchor.x = 0.5;
glass.anchor.y = 0.5;
PIXI.SCALE_MODES.DEFAULT = PIXI.SCALE_MODES.NEAREST;
PIXI.loader.add("./assets/assets_breh.json").load(ready);
PIXI.loader.add("./assets/sophisticat.json");

//audio
PIXI.loader.add("./assets/Blip_Select.wav").load(soundready);
PIXI.loader.add("./assets/Blip_Select3.wav").load(soundready);
PIXI.loader.add("./assets/brehgamemusic.wav").load(soundready);
var walk1;
var walk2;
var theme;
var sophisticat;
...
function soundready(){
    walk1 = PIXI.audioManager.getAudio("./assets/Blip_Select.wav");
    walk2 = PIXI.audioManager.getAudio("./assets/Blip_Select3.wav");
    theme = PIXI.audioManager.getAudio("./assets/brehgamemusic.wav");
    theme.loop = true;
    theme.play();
}
var blockarr = [];
...
cancel = new PIXI.Sprite(PIXI.Texture.fromImage("./assets/cancel_noitem.png"));
...
var glassreact = new PIXI.Sprite(PIXI.Texture.fromImage("./assets/glassreact.png"));
...
function dialogue() {
    dialogue_box = new PIXI.Sprite(PIXI.Texture.fromImage("./assets/sophisticatdio.png"));
...
var creditssc = new PIXI.Sprite(PIXI.Texture.fromImage("./assets/credits.png"));
...
function endgame(){
    theme.paused = true;
    end = new PIXI.Sprite(PIXI.Texture.fromImage("./assets/endscreen.png"));
    stage.addChild(end);
